...
public class ShooterColumIOSpark implements ShooterColumIO {
    ...
    public ShooterColumIOSpark(int shooter) {
        ...
        shooterPositionQueue = SparkOdometryThread.getInstance().registerSignal(shooterMotor,
                shooterEncoder::getPosition);
        shooterVelocityQueue = SparkOdometryThread.getInstance().registerSignal(shooterMotor,
    ...
    public void updateInputs(ShooterIOInputs inputs) {
        ...
        inputs.odometryShooterPositionsRad = shooterPositionQueue.stream().mapToDouble((Double value) -> value)
                .toArray();
        inputs.odometryShooterVelocityRot = shooterVelocityQueue.stream().mapToDouble((Double value) -> value)
                .toArray();
