...
public class Shooter extends SubsystemBase {
    ...
    public Shooter(ShooterColumIO OPshooterColumIO, ShooterColumIO IPshooterColimIO, ShooterColumIO IGShooterColumIO,
    ...
    public void periodic() {
        ...
        // Update odometry
        double[] sampleTimestamps = shooterColums[0].getOdometryTimestamps(); // All signals are sampled together
