...
public class ShooterIOInputsAutoLogged extends ShooterColumIO.ShooterIOInputs
  ...
  public void fromLog(org.littletonrobotics.junction.LogTable table) {
    ...
    odometryShooterPositionsRad =
        table.get("OdometryShooterPositionsRad", odometryShooterPositionsRad);
    odometryShooterVelocityRot =
        table.get("OdometryShooterVelocityRot", odometryShooterVelocityRot);
  }
